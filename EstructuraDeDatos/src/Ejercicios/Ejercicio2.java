...
public class Ejercicio2 {
	/*Declara un Array de nombre lista que estará formado por 25 datos de 
	...
	Posición 3: suma de los números enteros comprendidos entre 1 y el valor 
	            par más pequeño de lista. 
	
	Escribe a continuación el contenido de lista, así como los resultados 
