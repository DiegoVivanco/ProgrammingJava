            ...
            try {
                ...
                while(!reader.isEndElement()) {
                    if (reader.isStartElement() ){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.webserviceX.NET/","double").equals(reader.getName()) || new javax.xml.namespace.QName("","double").equals(reader.getName()) ){
